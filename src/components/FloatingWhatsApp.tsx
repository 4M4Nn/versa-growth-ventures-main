...
export default function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      <span className="absolute right-16 bg-[#25D366] text-white text-xs px-3 py-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
        Chat with us
      </span>
    </motion.a>
  )
